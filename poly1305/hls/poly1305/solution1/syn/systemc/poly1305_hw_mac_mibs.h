...
// ==============================================================
#ifndef __poly1305_hw_mac_mibs__HH__
#define __poly1305_hw_mac_mibs__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(poly1305_hw_mac_mibs) {
    ...
    SC_CTOR(poly1305_hw_mac_mibs):  simcore_mac_0_U ("simcore_mac_0_U") {
