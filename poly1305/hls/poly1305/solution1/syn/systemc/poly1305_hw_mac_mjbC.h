...
// ==============================================================
#ifndef __poly1305_hw_mac_mjbC__HH__
#define __poly1305_hw_mac_mjbC__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(poly1305_hw_mac_mjbC) {
    ...
    SC_CTOR(poly1305_hw_mac_mjbC):  simcore_mac_1_U ("simcore_mac_1_U") {
