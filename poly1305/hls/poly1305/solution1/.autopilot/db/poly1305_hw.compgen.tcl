...
set out_width 12
set exp i0*i1+i2
set arg_lists {i0 {8 0 +} i1 {4 0 +} m {12 0 +} i2 {4 0 +} p {12 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mac] == "ap_gen_simcore_mac"} {
eval "ap_gen_simcore_mac { \
...
set ID 574
set hasByteEnable 0
set MemName poly1305_hw_textBcud
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 8
set AddrRange 17
...
set ID 575
set hasByteEnable 0
set MemName poly1305_hw_accSum
set CoreName ap_simcore_mem
set PortList { 2 1 }
set DataWd 8
set AddrRange 17
...
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'input_stream_V_data'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    reset_level 0 \
    sync_rst true \
    corename {result_stream} \
    metadata {  } \
    op interface \
    ports { result_stream_TDATA { O 8 vector } result_stream_TREADY { I 1 bit } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'result_stream_V_data'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { result_stream_TVALID { O 1 bit } result_stream_TLAST { O 1 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'result_stream_V_last_V'"
}
}
